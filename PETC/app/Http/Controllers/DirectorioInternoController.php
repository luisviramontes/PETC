...
class DirectorioInternoController extends Controller
{
   ...
   public function perfil($id){
     ...
     if($tipo_usuario < 0 || $tipo_usuario > 7){
       ...
       $oficioe= OficiosEmitidosModel::join('directoriointerno','directoriointerno.id','=','oficiosemitidos.id_elabora')->join('directorioexterno','directorioexterno.id','=','oficiosemitidos.id_dirigido')->where('oficiosemitidos.id_elabora','=',$user)->select('oficiosemitidos.*','directoriointerno.nombre','directoriointerno.lic','directorioexterno.nombre_c','directorioexterno.lic as licext');

       $oficior= OficiosRecibidosModel::join('directoriointerno','directoriointerno.id','=','oficiosrecibidos.id_contesta')->where('oficiosrecibidos.id_contesta','=',$user)->select('oficiosrecibidos.*','directoriointerno.nombre','directoriointerno.lic');
     ...
     public function actualiza_perfil(Request $request,$id){
       $tipo_usuario = Auth::user()->tipo_usuario;
       if($tipo_usuario <> "2" && $tipo_usuario<>"5"){
         return view('permisos');
