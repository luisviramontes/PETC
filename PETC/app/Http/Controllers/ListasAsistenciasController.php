      ...
      if($request)
      {
        ...
        if($query == "" && $query2 == ""){
          ...
          ->select('listas_de_asistencias.id as id','listas_de_asistencias.id_centro_trabajo','listas_de_asistencias.mes'
           ...
           'centro_trabajo.nombre_escuela','centro_trabajo.cct'
           ,'region.region','region.sostenimiento'
           ,'ciclo_escolar.ciclo'
           ,'listas_de_asistencias.created_at','listas_de_asistencias.updated_at')
         ...
         ->select('listas_de_asistencias.id as id','listas_de_asistencias.id_centro_trabajo','listas_de_asistencias.mes'
           ,'listas_de_asistencias.estado','listas_de_asistencias.observaciones','listas_de_asistencias.captura',
           'centro_trabajo.nombre_escuela','centro_trabajo.cct','region.region','region.sostenimiento','ciclo_escolar.ciclo','listas_de_asistencias.created_at','listas_de_asistencias.updated_at')
...
public function recepcion_listas()
{
  $tipo_usuario = Auth::user()->tipo_usuario;
  if($tipo_usuario <> "2" || $tipo_usuario=="5"){
   return view('permisos');
  ...
  return view('nomina.listas_asistencias.recepcion', ['cct'=>$cct,'ciclos'=>$ciclos,'region'=>$region]);  
}
}


public function busca_listas_codigo($cct,$mes,$ciclo){
  $listas=DB::table('listas_de_asistencias')
  ->join('centro_trabajo','centro_trabajo.id','=','listas_de_asistencias.id_centro_trabajo')
  ->join('ciclo_escolar','ciclo_escolar.id','=','listas_de_asistencias.id_ciclo')
  ->where('centro_trabajo.cct','=',$cct)->where('listas_de_asistencias.mes','=',$mes)->where('ciclo_escolar.id','=',$ciclo)->select('listas_de_asistencias.id','listas_de_asistencias.mes','listas_de_asistencias.estado','centro_trabajo.nombre_escuela','centro_trabajo.cct','ciclo_escolar.ciclo')->get();
...
public function listas_codigo(Request $request){
  $tipo_usuario = Auth::user()->tipo_usuario;
  if($tipo_usuario <> "2" || $tipo_usuario=="5"){
   return view('permisos');
