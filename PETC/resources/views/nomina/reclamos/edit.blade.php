			...
			<div class="block-web">
				...
				<div class="porlets-content">
					<div  class="form-horizontal row-border" > <!--acomodo-->
						<form action="{{url('/reclamos', [$reclamo->id])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate files="true" enctype="multipart/form-data" accept-charset="UTF-8">
							{{csrf_field()}}
										...
										<div class="user-profile-content">
											...
											<div id="form-step-0" role="form" data-toggle="validator">
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<select name="personal" id="personal" class="form-control select2" onchange="cambia_reclamos();"  required disabled=>
															@foreach($captura as $personal) 
															@if($personal->id == $reclamo->id_personal)
															<option value="{{$personal->id}}_{{$personal->rfc}}_{{$personal->nombre}}_{{$personal->categoria}}_{{$personal->cct}}_{{$personal->nombre_escuela}}_{{$personal->fecha_inicio}}_{{$personal->fecha_termino}}" selected>
																{{$personal->nombre}}
															</option>
															@else
														...
														<input name="rfc" id="rfc" disabled type="text"   class="form-control" required value="{{$captura2->rfc}}" />
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input name="escuela" id="escuela" disabled type="text"   class="form-control" required value="{{$captura2->rfc}}"  />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input name="cct" id="cct" disabled type="text"   class="form-control" required value="{{$captura2->cct}}"  />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input name="categoria" id="categoria" disabled type="text"   class="form-control" required value="{{$captura2->categoria}}" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<input type="date" name="fechai" id="fechai" value="{{$captura2->fecha_inicio}}" class="form-control mask"  onchange="verifica_fecha()" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<input type="date" name="fechaf" id="fechaf" value="{{$captura2->fecha_termino}}" class="form-control mask"  onchange="verifica_fecha()" required >
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input name="dias" id="dias" onchange="calcula_monto();" type="text"   class="form-control" required value="{{$reclamo->total_dias}}" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input name="total" id="total"  type="text"   class="form-control" required value="{{$reclamo->total_reclamo}}" />
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<select name="dirigido_a" id="dirigido_a"  class="form-control select" ">
								...
								@if($dirigido2->id == $reclamo->id_oficio)
				...
				<div class="user-profile-content">
					<div id="form-step-1" role="form" data-toggle="validator">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input onchange="num_oficio();" maxlength="3" minlength="3" name="oficio_aux"  id="oficio_aux" class="form-control" required value="{{$reclamo->num_oficio}}" />
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label">N° Oficio: <strog class="theme_color">*</strog></label>
							<div class="col-sm-6">
								<input name="oficio" type="text" id="oficio"  value="{{$reclamo->oficio}}" class="form-control" required onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"  />
							</div>
						</div>
						<br> <br>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<textarea  name="motivo" type="text" id="motivo" class="form-control" required vonKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" rows="10" cols="30"> {{$reclamo->motivo}}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="genero" id="genero"  class="form-control select" ">
									...
									@if($reclamo->id_elabora == $genero->id)
									<option value='{{$genero->abrebiatura}}_{{$genero->id}}' selected>
										{{$genero->nombre}}
									</option>
									@else
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="fecha" type="date" id="fecha" value="{{$reclamo->salida}}"  class="form-control" required />
							</div>
						</div>
