{!! Form::open(['route' => ['nomina_estatal.index'],'method' => 'GET','autocomplete'=>'off','role'=>'search']) !!}
...
<div class="form-group">
						...
						<div class="col-sm-6">
							<select name="ciclo_escolar" id="ciclo_escolar" class="form-control select2" onchange="enviar_ciclo14();" >
