			...
			<div class="block-web">
				...
				<div class="porlets-content">
					<div  class="form-horizontal row-border" > <!--acomodo-->
						<form action="{{url('/cambios_cct_est', [$personal->id])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate files="true" enctype="multipart/form-data" accept-charset="UTF-8">
							{{csrf_field()}}
											...
											<div id="form-step-1" role="form" data-toggle="validator">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<select name="cct" id="cct" class="form-control select2"   value="{{Input::old('cct')}}"  onchange="captura_personal()" required>
															@foreach($cct as $ct)
															@if($personal->id_cct_anterior == $ct->id)
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<select name="cct_nuevo" id="cct_nuevo" class="form-control select2"   value="{{Input::old('cct')}}"  onchange="captura_personal()" >
															@foreach($cct as $ct)
															@if($personal->id_cct_nuevo == $ct->id)
															<option value="{{$ct->id}}" selected>
																{{$ct->cct}}
															</option>
															@else
												...
												<div class="form-group">
													<div class="col-sm-offset-7 col-sm-5">
														...
														<a href="{{url('/cambios_cct_est')}}" class="btn btn-default"> Cancelar</a>
													</div>
												</div><!--/form-group--> 
