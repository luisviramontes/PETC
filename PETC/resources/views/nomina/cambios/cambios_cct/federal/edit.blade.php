			...
			<div class="block-web">
				...
				<div class="porlets-content">
					<div  class="form-horizontal row-border" > <!--acomodo-->
						<form action="{{url('/cambios_cct_fed', [$personal->id])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate files="true" enctype="multipart/form-data" accept-charset="UTF-8">
							{{csrf_field()}}
											...
											<div id="form-step-1" role="form" data-toggle="validator">
												...
												<div class="form-group">
													<div class="col-sm-offset-7 col-sm-5">
														...
														<a href="{{url('/cambios_cct_fed')}}" class="btn btn-default"> Cancelar</a>
													</div>
												</div><!--/form-group--> 
