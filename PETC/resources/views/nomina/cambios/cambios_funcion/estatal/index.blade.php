				...
				<div class="header">
					<div class="row" style="margin-top: 15px; margin-bottom: 12px;">
						<div class="col-sm-7">
							...
							<h2 class="content-header" style="margin-top: -5px;">&nbsp;&nbsp;<strong>CAMBIOS DE FUNCIÓN PETC ESTATALES PENDIENTES: {{$contador}}</strong></h2>
							@include('nomina.cambios.cambios_funcion.estatal.search')
						</div>
						<div class="col-md-5">
							<div class="btn-group pull-right">
								<b>
									...
									<div class="btn-group" style="margin-right: 10px;">
										...
										<a class="btn btn-sm btn-warning tooltips" href="{{ route('nomina.cambios_festatal.excel')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Descargar"> <i class="fa fa-download"></i> Descargar </a>  										
										...
										<td style="background-color: #DBFFC2;" >{{$datos->categoria_nueva}} </td>
											...
											<th style="display:none;" >{{$datos->ciclo}} </td>	
												...
												<td style="background-color: #DBFFC2;">
													...
													<td style="background-color: #DBFFC2;"> 
														<a href="{{URL::action('CambiosFunEstController@edit',$datos->id)}}" class="btn btn-primary btn -sm" role="button"><i class="fa fa-edit"></i></a></td>
														<td style="background-color: #DBFFC2;">
																	...
																	<td style="background-color: #FFE4E1;" >{{$datos->categoria_nueva}} </td>	
																		...
																		<th style="display:none;" >{{$datos->ciclo}} </td>
																			...
																			<td style="background-color: #FFE4E1;">
																				...
																				<td style="background-color: #FFE4E1;"> 
																					<a href="{{URL::action('CambiosFunEstController@edit',$datos->id)}}" class="btn btn-primary btn -sm" role="button"><i class="fa fa-edit"></i></a>  
																				</td>
																				<td style="background-color: #FFE4E1;">
																					</
																				</td>
																				...
																				@endif
																				@include('nomina.cambios.cambios_funcion.estatal.modale')
																				@include('nomina.cambios.cambios_funcion.estatal.modal')
