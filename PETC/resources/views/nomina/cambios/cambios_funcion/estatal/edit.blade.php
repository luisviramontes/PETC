...
<div class="pull-left breadcrumb_admin clear_both">
	<div class="pull-left page_title theme_color">
		<h1>Modificar Registro de Cambio de CTE</h1>
		<h2 class="active"></h2>
	</div>
			...
			<div class="block-web">
				...
				<div class="porlets-content">
					<div  class="form-horizontal row-border" > <!--acomodo-->
						<form action="{{url('/cambios_funcion_est', [$personal->id])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate files="true" enctype="multipart/form-data" accept-charset="UTF-8">
							{{csrf_field()}}
										...
										<div class="user-profile-content">
											<div id="form-step-1" role="form" data-toggle="validator">
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<select name="movimiento" id="movimiento" class="form-control select" onchange="captura_personal(this.value)" required disabled="true">
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														...
														<input type="date" onchange="verifica_fecha()" name="fechai" id="fechai" value="{{$personal->fecha_inicio}}" class="form-control mask" required>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														...
														<input type="date" name="fechaf" id="fechaf" value="{{$personal->fecha_baja}}" class="form-control mask"  onchange="verifica_fecha()"" required >
													</div>
												...
												<div class="form-group">
													<div class="col-sm-offset-7 col-sm-5">
														...
														<a href="{{url('/cambios_funcion_est')}}" class="btn btn-default"> Cancelar</a>
													</div>
												</div><!--/form-group--> 
												...
												<div class="form-group">
													<div class="col-sm-6">
														<input  id="ct_anterior"  name="ct_anterior" type="hidden"  class="form-control""/>
													</div>
												</div>
