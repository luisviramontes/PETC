			...
			<div class="block-web"> 
				<div class="header">
					<div class="row" style="margin-top: 15px; margin-bottom: 12px;">
						<div class="col-sm-7">
							...
							<h2 class="content-header" style="margin-top: -5px;">&nbsp;&nbsp;<strong>CAMBIOS DE FUNCIÓN PETC FEDERALES PENDIENTES: {{$contador}}</strong></h2>
							@include('nomina.cambios.cambios_funcion.federal.search')
						</div>
						<div class="col-md-5">
							<div class="btn-group pull-right">
								<b>
									...
									<div class="btn-group" style="margin-right: 10px;">
										...
										<a class="btn btn-sm btn-warning tooltips" href="{{ route('nomina.cambios_ffederal.excel')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Descargar"> <i class="fa fa-download"></i> Descargar </a>  										
				...
				<div class="porlets-content" >
					<div class="table-responsive">
						<table cellpadding="0" cellspacing="0" border="0"  class="display table table-bordered " id="hidden-table-info12" >
							<thead>   
								<tr>
									<th>Región</th>
									<th>RFC </th>  
							...
							<tbody>
								...
								<tr class="gradeX">									
									...
									<th style="display:none;" >{{$datos->sostenimiento}} </td>	
										...
										<td style="background-color: #DBFFC2;" >{{$datos->categoria_nueva}} </td>
											<td style="background-color: #DBFFC2;" >{{$datos->categoria_anterior}} </td>
											...
											<th style="display:none;" >{{$datos->ciclo}} </td>	
												...
												<td style="background-color: #DBFFC2;">
													...
													<td style="background-color: #DBFFC2;"> 
														<a href="{{URL::action('CambiosFunFedController@edit',$datos->id)}}" class="btn btn-primary btn -sm" role="button"><i class="fa fa-edit"></i></a></td>
														<td style="background-color: #DBFFC2;">
															<a class="btn btn-danger btn-sm" data-target="#modal-delete-{{$datos->id}}" data-toggle="modal" style="margin-right: 10px;"  role="button"><i class="fa fa-eraser"></i></a></td>
															...
															<tr class="gradeX">									
																...
																<th style="display:none;" >{{$datos->sostenimiento}} </td>	
																	<th style="display:none;" >{{$datos->cat_puesto}} </td>
																	<td style="background-color: #FFE4E1;" >{{$datos->categoria_nueva}} </td>	
																		<td style="background-color: #FFE4E1;" >{{$datos->categoria_anterior}} </td>	
																		...
																		<th style="display:none;" >{{$datos->ciclo}} </td>
																			...
																			<td style="background-color: #FFE4E1;">
																				...
																				<td style="background-color: #FFE4E1;"> 
																					<a href="{{URL::action('CambiosFunFedController@edit',$datos->id)}}" class="btn btn-primary btn -sm" role="button"><i class="fa fa-edit"></i></a>  
																				</td>
																				<td style="background-color: #FFE4E1;">
																					</
																				</td>
																				...
																				@endif
																				@include('nomina.cambios.cambios_funcion.federal.modale')
																				@include('nomina.cambios.cambios_funcion.federal.modal')
