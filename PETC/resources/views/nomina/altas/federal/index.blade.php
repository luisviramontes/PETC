...
<h2 class="content-header" style="margin-top: -5px;">&nbsp;&nbsp;<strong>ALTAS PETC FEDERALES PENDIENTES: {{$contador}}</strong></h2>
@include('nomina.altas.federal.search')
</div>
<div class="col-md-5">
...
<a class="btn btn-sm btn-warning tooltips" href="{{ route('nomina.altas_federales.excel')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Descargar"> <i class="fa fa-download"></i> Descargar </a>
...
<td style="background-color: #DBFFC2;">
<a href="{{URL::action('AltasFedController@edit',$datos->id)}}" class="btn btn-primary btn -sm" role="button"><i class="fa fa-edit"></i></a>
</td>
<td style="background-color: #DBFFC2;">
...
@endif
@include('nomina.altas.federal.modale')
@include('nomina.altas.federal.modal')
