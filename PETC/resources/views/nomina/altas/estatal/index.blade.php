				...
				<div class="header">
					<div class="row" style="margin-top: 15px; margin-bottom: 12px;">
						<div class="col-sm-7">
							...
							<h2 class="content-header" style="margin-top: -5px;">&nbsp;&nbsp;<strong>ALTAS PETC ESTATALES PENDIENTES: {{$contador}}</strong></h2>
							@include('nomina.altas.estatal.search')
						</div>
						<div class="col-md-5">
							<div class="btn-group pull-right">
								<b>
									...
									<div class="btn-group" style="margin-right: 10px;">
										...
										<a class="btn btn-sm btn-warning tooltips" href="{{ route('nomina.altas_estatales.excel')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Descargar"> <i class="fa fa-download"></i> Descargar </a>  										
						...
						<table cellpadding="0" cellspacing="0" border="0"  class="display table table-bordered " id="hidden-table-info9" >
							<thead>   
								<tr>
									...
									<th>Activar</th>
									<th style="display:none;" >Personal a Cubrir</th>
                                    <th style="display:none;" >RFC del Personal a Cubrir</th>						
										...
										<th style="display:none;" >{{$datos->cat_puesto}} </td>	
											...
											<th style="display:none;" >{{$datos->ciclo}} </td>	
												...
												<td style="background-color: #DBFFC2;">
													...
													<td style="background-color: #DBFFC2;"> 
														<a href="{{URL::action('AltasEstController@edit',$datos->id)}}" class="btn btn-primary btn -sm" role="button"><i class="fa fa-edit"></i></a>  
													</td>
													<td style="background-color: #DBFFC2;">
													...
													<td style="display:none;" >No Cubre a Nadie </td>
                                                    <td style="display:none;" >No Cubre a Nadie </td>
															...
															<th style="display:none;" >{{$datos->cat_puesto}} </td>	
																...
																<th style="display:none;" >{{$datos->ciclo}} </td>	
																	...
																	<td style="background-color: #FFE4E1;">
																		...
																		@endif
																		@include('nomina.altas.estatal.modale')
																		@include('nomina.altas.estatal.modal')
...
@if ($datos->estado == "RESUELTO")
<tr class="gradeX">
<td style="background-color: #DBFFC2;">{{$datos->region}} {{$datos->nombre_baja}} </td>
<td style="background-color: #DBFFC2;">{{$datos->rfc}} </td>
<td style="background-color: #DBFFC2;">{{$datos->nombre}} </td>
<td style="display:none;" >{{$datos->telefono}}</td>
<td style="display:none;" >{{$datos->email}} </td>
...
<td style="display:none;" >{{$datos->tipo_movimiento}} </td>
<td style="background-color: #DBFFC2;"></td>
<td style="display:none;" >{{$datos->nombre_baja}} </td>
<td style="display:none;" >{{$datos->rfc_baja}} </td>
