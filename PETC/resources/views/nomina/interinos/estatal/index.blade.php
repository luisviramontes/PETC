				...
				<div class="header">
					<div class="row" style="margin-top: 15px; margin-bottom: 12px;">
						<div class="col-sm-7">
							...
							<h2 class="content-header" style="margin-top: -5px;">&nbsp;&nbsp;<strong>INTERINOS PETC ESTATALES PENDIENTES: {{$contador}}</strong></h2>
							@include('nomina.interinos.estatal.search')
						</div>
						<div class="col-md-5">
							<div class="btn-group pull-right">
								<b>
									...
									<div class="btn-group" style="margin-right: 10px;">
										...
										<a class="btn btn-sm btn-warning tooltips" href="{{ route('nomina.interinos-est.excel')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Descargar"> <i class="fa fa-download"></i> Descargar </a>  										
											...
											<td style="background-color: #DBFFC2;">
												...
												<tr class="gradeX">									
													...
													<th style="display:none;" >{{$datos->sostenimiento}} </td>	
														...
														<td style="display:none;" >{{$datos->observaciones}} </td>	
														<td style="display:none;" >{{$datos->cct_2}} </td>	
														<th style="display:none;" >{{$datos->captura}} </td>	
															...
															<th style="display:none;" >{{$datos->ciclo}} </td>	
																...
																<td style="background-color: #FFE4E1;">
																	...
																	@include('nomina.interinos.estatal.modale')
