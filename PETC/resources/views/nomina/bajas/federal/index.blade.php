				...
				<div class="header">
					<div class="row" style="margin-top: 15px; margin-bottom: 12px;">
						<div class="col-sm-7">
							...
							<h2 class="content-header" style="margin-top: -5px;">&nbsp;&nbsp;<strong>BAJAS PETC FEDERALES PENDIENTES: {{$contador}}</strong></h2>
										...
										<th style="display:none;" >{{$datos->cat_puesto}} </td>	
											...
											<th style="display:none;" >{{$datos->ciclo}} </td>	
												...
												<td style="background-color: #DBFFC2;">
													...
													<td style="background-color: #DBFFC2;"> 
														<a href="{{URL::action('BajasFedController@edit',$datos->id)}}" class="btn btn-primary btn -sm" role="button"><i class="fa fa-edit"></i></a>  
													</td>
													<td style="background-color: #DBFFC2;">
															...
															<th style="display:none;" >{{$datos->cat_puesto}} </td>	
																...
																<th style="display:none;" >{{$datos->ciclo}} </td>	
																	...
																	<td style="background-color: #FFE4E1;">
																		...
																		@endif
																		@include('nomina.bajas.federal.modale')
																		@include('nomina.bajas.federal.modal')
