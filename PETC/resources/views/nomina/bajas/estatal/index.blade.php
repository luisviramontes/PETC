			...
			<div class="block-web"> 
				<div class="header">
					<div class="row" style="margin-top: 15px; margin-bottom: 12px;">
						<div class="col-sm-7">
							...
							<h2 class="content-header" style="margin-top: -5px;">&nbsp;&nbsp;<strong>BAJAS PETC ESTATALES PENDIENTES: {{$contador}}</strong></h2>
							@include('nomina.bajas.federal.search')
						</div>
						<div class="col-md-5">
							<div class="btn-group pull-right">
								<b>
									...
									<div class="btn-group" style="margin-right: 10px;">
										...
										<a class="btn btn-sm btn-warning tooltips" href="{{ route('nomina.bajas_federales.excel')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Descargar"> <i class="fa fa-download"></i> Descargar </a>  										
				...
				<div class="porlets-content" >
					<div class="table-responsive">
						<table cellpadding="0" cellspacing="0" border="0"  class="display table table-bordered " id="hidden-table-info10" >
							<thead>   
								<tr>
									<th>Región</th>
									<th>RFC </th>
									...
									<th>Activar</th>
									<th style="display:none;" >Personal que lo Cubre</th>
									<th style="display:none;" >RFC del Personal que lo Cubre</th>	 					
								...
								<tr class="gradeX">									
									...
									<th style="display:none;" >{{$datos->sostenimiento}} </td>	
										<th style="display:none;" >{{$datos->cat_puesto}} </td>	
											...
											<td style="background-color: #DBFFC2;">{{$datos->fecha_baja}} </td>
											...
											<th style="display:none;" >{{$datos->ciclo}} </td>	
												...
												<td style="background-color: #DBFFC2;">
													...
													<td style="background-color: #DBFFC2;">  
														<a href="{{URL::action('BajasEstController@edit',$datos->id)}}" class="btn btn-primary btn -sm" role="button"><i class="fa fa-edit"></i></a>  
													</td>
													<td style="background-color: #DBFFC2;">
													...
													<td style="display:none;" >No Lo Cubre Nadie </td>
                                                    <td style="display:none;" >No Lo Cubre Nadie </td>
													...
													<tr class="gradeX">									
														...
														<th style="display:none;" >{{$datos->sostenimiento}} </td>	
															<th style="display:none;" >{{$datos->cat_puesto}} </td>	
																...
																<td style="background-color: #FFE4E1;">{{$datos->fecha_baja}} </td>			
																<td style="display:none;" >{{$datos->documentacion_entregada}} </td>	
																<td style="display:none;" >{{$datos->observaciones}} </td>	
																<td style="display:none;" >{{$datos->cct_2}} </td>	
																...
																<th style="display:none;" >{{$datos->ciclo}} </td>	
																	...
																	<td style="background-color: #FFE4E1;">
																		...
																		@endif
																		@include('nomina.bajas.estatal.modale')
																		@include('nomina.bajas.estatal.modal')
										...
										<th style="display:none;" >{{$datos->cat_puesto}} </td>	
											...
											<th style="display:none;" >{{$datos->ciclo}} </td>	
												...
												<td style="background-color: #DBFFC2;">
													...
													<td style="display:none;" >{{$datos->nombre_alta}} </td>
                                                    <td style="display:none;" >{{$datos->rfc_alta}} </td>
