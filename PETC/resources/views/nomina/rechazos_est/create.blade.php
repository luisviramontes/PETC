...
<div class="pull-left breadcrumb_admin clear_both">
	<div class="pull-left page_title theme_color">
		<h1>Inicio</h1>
		<h2 class="">Capturar Rechazo Estatal</h2>
	</div>
	<div class="pull-right">
		<ol class="breadcrumb">
			<li><a style="color: #808080" href="{{url('bancos')}}">Inicio</a></li>
			<li><a style="color: #808080" href="{{url('bancos')}}">Capturar Rechazo Estatal</a></li>
		</ol>
	</div>
</div>
				...
				<div class="header">
					<div class="row" style="margin-top: 15px; margin-bottom: 12px;">
						<div class="col-sm-8">
							...
							<h2 class="content-header" style="margin-top: -5px;"><strong>Agregar Rechazo Estatal</strong></h2>
