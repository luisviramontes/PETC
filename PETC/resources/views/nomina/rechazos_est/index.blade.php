							...
							<div class="btn-group pull-right">
								<b>
									...
									-->
										...
										<a class="btn btn-primary btn-sm" href="{{URL::action('RechazosEstController@invoice','2018-2019')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Descargar"> <i class="fa fa-print"></i> Generar PDF</a>
