		...
		<div class="col-md-12">
			<div class="block-web">
				...
				<div class="porlets-content">
					<form action="{{url('/directorio_externo', [$personal->id])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate files="true" enctype="multipart/form-data" accept-charset="UTF-8">
						{{csrf_field()}}
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="nombre" id="nombre" type="text" onchange="cambia_nombre();" onkeypress="return soloLetras(event)"  class="form-control" required value="{{$personal->nombre_c}}"   onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="paterno" id="paterno" type="text" onchange="cambia_nombre();" onkeypress="return soloLetras(event)"  class="form-control" required value="{{$personal->apellido1}}"   onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="materno" id="materno" type="text" onchange="cambia_nombre();" onkeypress="return soloLetras(event)"  class="form-control" required value="{{$personal->apellido2}}"   onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="a_n" id="a_n" type="text"  onkeypress="return soloLetras(event)"  class="form-control" required value="{{$personal->a_n}}"   onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="direccion" id="direccion" type="text" onchange="cambia_direccion();" onkeypress="return soloLetras(event)"  class="form-control" required value="{{$personal->direccion}}"   onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="a_d" id="a_d" type="text" onkeypress="return soloLetras(event)"  class="form-control" required value="{{$personal->a_d}}"   onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="email" id="email" type="text"   class="form-control"  value="{{$personal->correo}}" />
							</div>
						</div>
