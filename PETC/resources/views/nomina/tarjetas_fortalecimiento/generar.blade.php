...
<div class="pull-left breadcrumb_admin clear_both">
	<div class="pull-left page_title theme_color">
		<h1>Inicio</h1>
		<h2 class="">Generar Cartas Compromiso</h2>
	</div>
	<div class="pull-right">
		<ol class="breadcrumb">
			<li><a style="color: #808080" href="{{url('tarjetas_fortalecimiento')}}">Inicio</a></li>
			<li><a style="color: #808080" href="{{url('tarjetas_fortalecimiento')}}">Cartas Compromiso </a></li>
		</ol>
	</div>
</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="block-web">
				<div class="header">
					<div class="row" style="margin-top: 15px; margin-bottom: 12px;">
						<div class="col-sm-8">
							...
							<h2 class="content-header" style="margin-top: -5px;"><strong>Generar Cartas Compromiso R.Fortalecimeinto</strong></h2>
						</div>
						<div class="col-md-4">
				...
				<div class="porlets-content">				
					<div class="porlets-content">
						<div  class="form-horizontal row-border" > <!--acomodo-->
							<form class="" id="myForm" action="{{route('nomina.tarjetas_fortalecimiento.generar_pdf_cartas')}}" method="post" role="form" enctype="multipart/form-data" parsley-validate novalidate data-toggle="validator">
								{{csrf_field()}}
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">Mes de Vencimiento <strog class="theme_color">*</strog></label>
					<div class="col-sm-6">
