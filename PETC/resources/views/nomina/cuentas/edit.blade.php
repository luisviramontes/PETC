...
<div class="pull-left breadcrumb_admin clear_both">
	...
	<div class="pull-right">
		<ol class="breadcrumb">
			<li><a style="color: #808080" href="{{url('cuentas')}}">Inicio</a></li>
			<li><a style="color: #808080" href="{{url('cuentas')}}">Editar Cuenta</a></li>
		</ol>
	</div>
</div>
<div class="container clear_both padding_fix">
	<div class="row">
		<div class="col-md-12">
				...
				<div class="header">
					<div class="row" style="margin-top: 15px; margin-bottom: 12px;">
						<div class="col-sm-8">
							...
							<h2 class="content-header" style="margin-top: -5px;"><strong>Editar Cuenta</strong></h2>
						</div>
						<div class="col-md-4">
          ...
          <form action="{{url('/cuentas', [$cuentas->id])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate files="true" enctype="multipart/form-data" accept-charset="UTF-8">
						{{csrf_field()}}
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="nombre" id="nombre" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" type="text" maxlength=""  class="form-control valid" required value="{{$cuentas->nombre}}" />
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="num_cuenta" id="num_cuenta" type="text" onkeypress="soloNumeros(event)"  class="form-control valid" required value="{{$cuentas->num_cuenta}}" />
								<div class="help-block with-errors"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="clave_in" id="clave_in" type="text" onkeypress="soloNumeros(event)"  class="form-control valid" required value="{{$cuentas->clave_in}}" />
								<div class="help-block with-errors"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="secretaria" id="secretaria" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" type="text" maxlength=""  class="form-control valid" required value="{{$cuentas->secretaria}}" />
								<div class="help-block with-errors"></div>
