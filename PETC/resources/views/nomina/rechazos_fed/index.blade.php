								...
								<b>
									...
									<div class="btn-group" style="margin-right: 10px;">
										...
										-->
											...
											<a class="btn btn-primary btn-sm" href="{{URL::action('RechazosFederalController@invoice','2019-2020')}}" target="_blank" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Descargar"> <i class="fa fa-print"></i> Generar PDF</a>
