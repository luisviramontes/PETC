				...
				<div class="porlets-content">
					<form action="{{route('cat_puesto.store')}}" method="post" class="form-horizontal row-border" parsley-validate novalidate  files="true" enctype="multipart/form-data" accept-charset="UTF-8">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="cv_ur" type="number" onkeypress="soloNumeros(event)"  class="form-control" required value="{{Input::old('cv_ur')}}" />
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="ccp" type="text"  class="form-control" required value="{{Input::old('ccp')}}" />
								<div class="help-block with-errors"></div>
							<!--	<div class="text-danger" id='error_ciclo'>{{$errors->formulario->first('ciclo')}}</div>
							--></div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="nom_prog" type="text"  class="form-control" required value="{{Input::old('nom_prog')}}" />
								<div class="help-block with-errors"></div>
							<!--	<div class="text-danger" id='error_ciclo'>{{$errors->formulario->first('ciclo')}}</div>
							--></div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="cat_puesto" type="text"  class="form-control" required value="{{Input::old('cat_puesto')}}" />
								<div class="help-block with-errors"></div>
							<!--	<div class="text-danger" id='error_ciclo'>{{$errors->formulario->first('ciclo')}}</div>
							--></div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="des_puesto" type="text"  class="form-control" required value="{{Input::old('des_puesto')}}" />
								<div class="help-block with-errors"></div>
							<!--	<div class="text-danger" id='error_ciclo'>{{$errors->formulario->first('ciclo')}}</div>
							--></div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="categoria" type="text"  class="form-control" required value="{{Input::old('categoria')}}" />
								<div class="help-block with-errors"></div>
							<!--	<div class="text-danger" id='error_ciclo'>{{$errors->formulario->first('ciclo')}}</div>
							--></div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label">Tipo de Puesto: <strog class="theme_color">*</strog></label>
							<div class="col-sm-6">
								<input name="tipo_puesto" type="text"  class="form-control" required value="{{Input::old('tipo_puesto')}}" />
								<div class="help-block with-errors"></div>
							<!--	<div class="text-danger" id='error_ciclo'>{{$errors->formulario->first('ciclo')}}</div>
							--></div>
						</div>
