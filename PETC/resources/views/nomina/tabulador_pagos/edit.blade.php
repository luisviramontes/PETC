...
<div class="pull-left breadcrumb_admin clear_both">
	<div class="pull-left page_title theme_color">
		<h1>Inicio</h1>
		<h2 class="">Editar Tabla de Pagos Por Empleado</h2>
	</div>
		...
		<div class="col-md-12">
			<div class="block-web">
				<div class="header">
					<div class="row" style="margin-top: 15px; margin-bottom: 12px;">
						<div class="col-sm-8">
							...
							<h2 class="content-header" style="margin-top: -5px;"><strong>Editar Pago Por Empleado Ciclo: {{$pago->ciclo}}</strong></h2> 
						</div>
						<div class="col-md-4">
				...
				<div class="porlets-content">
					<form action="{{url('/tabulador_pagos', [$pago->id])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate files="true" enctype="multipart/form-data" accept-charset="UTF-8">
						{{csrf_field()}}
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="pago_intendente" id="pago_intendente"  type="number"   class="form-control"  value="{{$pago->pago_intendente}}" required value="50" maxlength="3" min="1" max ="999"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="ciclo" class="form-control" required>
									...
									@if($pago->ciclo == $ciclo->ciclo)
									<option value="{{$ciclo->ciclo}}" selected>{{$ciclo->ciclo}}</option>
									@else
