...
<div class="pull-left breadcrumb_admin clear_both">
	<div class="pull-left page_title theme_color">
		<h1>Estadistica 911 PETC </h1>
		<h2 class="">Estadistica 911 PETC</h2>
	</div>
	<div class="pull-right">
		<ol class="breadcrumb">
			<li ><a style="color: #808080" href="{{url('/estadistica911')}}">Inicio</a></li>
			<li class="active">Estadistica 911 PETC</a></li>
		</ol>
	</div>
</div>
			...
			<div class="block-web">
				<div class="header">
					<div class="row" style="margin-top: 15px; margin-bottom: 12px;">
						<div class="col-sm-7">
							...
							<h2 class="content-header" style="margin-top: -5px;">&nbsp;&nbsp;<strong>Estadistica 911 PETC </strong></h2>
							@include('nomina.estadistica911.search')
						</div>
						<div class="col-md-5">
							<div class="btn-group pull-right">
								<b>
									...
									<div class="btn-group" style="margin-right: 10px;">
										<a class="btn btn-sm btn-success tooltips" href="{{ route('estadistica911.create')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Registrar Nuevo CT"> <i class="fa fa-plus"></i> Registrar </a>


										<a class="btn btn-sm btn-warning tooltips" href="{{ route('nomina.descargar-estadistica911.excel','2')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" id="excel" title="" data-original-title="Descargar"> <i class="fa fa-download"></i> Descargar </a>
				...
				<div class="porlets-content">
					<div class="table-responsive">
						<table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered " id="hidden-table-info21">
							<thead>
								<tr>
									<th>CCT </th>
