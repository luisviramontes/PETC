				...
				<div class="header">
					<div class="row" style="margin-top: 15px; margin-bottom: 12px;">
						<div class="col-sm-7">
							...
							<h2 class="content-header" style="margin-top: -5px;">&nbsp;&nbsp;<strong>INASISTENCIAS PENDIENTES: {{$contador}}</strong></h2>
							@include('nomina.inasistencias.search')
							...
							<div class="btn-group pull-right">
								<b>
									...
									<div class="btn-group" style="margin-right: 10px;">
										<a class="btn btn-sm btn-success tooltips" href="{{ route('inasistencias.create')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Registrar Nuevo Empleado"> <i class="fa fa-plus"></i> Registrar </a>


										<a class="btn btn-sm btn-warning tooltips" href="{{ route('nomina.inasistencias.excel',$id)}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Descargar"> <i class="fa fa-download"></i> Descargar </a>  										
								...
								<tr class="gradeX">									
									...
									<th style="display:none;" >{{$datos->sostenimiento}} </td>	
										<th style="display:none;" >{{$datos->cat_puesto}} </td>	
											...
											<td style="background-color: #DBFFC2;">{{$datos->dia}} {{$datos->mes}} </td>
											<th style="display:none;" > {{$datos->ciclo_ina}}</td>	
											<th style="display:none;" > {{$datos->observaciones_ina}}</td>											
												...
												<td style="display:none;" >{{$datos->captura}} </td>	
												...
												<th style="display:none;" >{{$datos->ciclo}} </td>	
													...
													<td style="background-color: #DBFFC2;">
														...
														<td style="background-color: #DBFFC2;"> 
															<a href="{{URL::action('InasistenciasController@edit',$datos->id)}}" class="btn btn-primary btn -sm" role="button"><i class="fa fa-edit"></i></a>  
														</td>
														<td style="background-color: #DBFFC2;">
														...
														<td style="display:none;" ><a href="{{URL::action('InasistenciasController@verInformacion',$datos->idcaptura.'/1')}}" class="btn btn-primary btn-sm" role="button"><i class="fa fa-eye"></i></a>    </td>
														...
														<tr class="gradeX">									
															...
															<th style="display:none;" >{{$datos->sostenimiento}} </td>	
																<th style="display:none;" >{{$datos->cat_puesto}} </td>	
																	...
																	<td style="background-color: #FFE4E1;">{{$datos->dia}} {{$datos->mes}}</td>	
																	<th style="display:none;" > {{$datos->ciclo_ina}}</td>
																	<th style="display:none;" > {{$datos->observaciones_ina}}</td>
