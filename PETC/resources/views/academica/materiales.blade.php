		...
		<section class="banner-area relative">
			...
			<div class="container">
				<div class="row justify-content-between align-items-center text-center banner-content">
					<div class="col-lg-12">
						<h1 class="text-white">Materiales de Apoyo</h1>
						<p></p>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row align-items-center justify-content-center">
					...
					<div class="col-lg-5 col-md-12 about-right">
						...
						<div align="justify">
							<p>
								El propósito de esta línea es poner en contacto permanente a los alumnos con diversos textos, así
								como fomentar que desarrollen estrategias de comprensión lectora para el análisis y el manejo de
								la información, y el incremento de sus recursos discursivos, al tiempo que adquieren una actitud
								favorable hacia la lectura y producen textos para expresarse libremente, el espacio privilegiado
								para estas actividades es la biblioteca escolar.

								El trabajo con esta línea permite desarrollar en los
								alumnos habilidades como comunicarse, escuchar
								al otro, interactuar con su grupo de pares o
								adultos, asimismo favorece el gusto por la lectura
			...
			<div class="container">
				<div class="row align-items-center justify-content-center">
					...
					<div class="col-lg-5 col-md-12 about-right">
						...
						<div align="justify">
							<p>
								Formar lectores y productores de textos es una tarea
								fundamental, ya que permite acercar cultura a quienes
...
<br/>de Clase</h2>
						...
						<div align="justify">
							<p>
								En la búsqueda de opciones que permitan a los supervisores y directores escolares
observar el trabajo cotidiano en las aulas y proporcionarles un medio
para asesorar y acompañar académicamente a los docentes y las prácticas
de gestión en las escuelas, se presenta el manual Observación de clase.
Herramientas para el supervisor como un recurso para obtener información
