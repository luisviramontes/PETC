			...
			<div class="container">
				<div class="row align-items-center justify-content-center">
					<div class="col-lg-7 col-md-12 about-left">						
						<a target="_blank"  href="img/capacitaciones/'.$capacitaciones->archivo.jpeg"><img  class="img-fluid" src="{{asset('img/capacitaciones/'.$capacitaciones->archivo)}}"  title="$capacitaciones->nombre_capacitacion" ></a>
					</div>
					<div class="col-lg-5 col-md-12 about-right">
						<div class="section-title text-left">
							...
							<div align="justify">
								<p>
									<b> DIRIJIDO PARA:<b/> {{$capacitaciones->dirigido}} <br/>
