...
<div class="pull-left breadcrumb_admin clear_both">
	<div class="pull-left page_title theme_color">
		<h1>Registrar Capacitaciones</h1>
		<h2 class="active"></h2>
	</div>
	<div class="pull-right">
		<ol class="breadcrumb">
			<li><a href="?c=Inicio">Inicio</a></li>
			<li><a href="?c=">Registrar Capacitaciones</a></li>
			<li class="active"></li>
		</ol>
	</div>
</div>
			...
			<div class="block-web">
				...
				<div class="porlets-content">
					<div  class="form-horizontal row-border" > <!--acomodo-->
						<form class="" id="myForm" action="{{route('capacitaciones.store')}}" method="post" role="form" enctype="multipart/form-data" parsley-validate novalidate data-toggle="validator">
							{{csrf_field()}}
							<div id="smartwizard">
								<ul>
									<li><a href="#step-1">Registrar Capacitaciónes</a></li>
									<li><a href="#step-2">Registrar Capacitaciónes</a></li>
								</ul>
								<div>
									<div id="step-1" class="">
										<div class="user-profile-content">
											...
											<div id="form-step-0" role="form" data-toggle="validator">
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input name="nombre_c" id="nombre_c" type="text"   class="form-control" required value="{{Input::old('nombre_c')}}"   onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" />
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														...
														<input type="time" name="hora" value="11:45:00" max="22:30:00" min="10:00:00" step="1"  required>
													</div>
												</div>
										...
										<div class="user-profile-content">
											<div id="form-step-1" role="form" data-toggle="validator">
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input name="imparte" id="imparte" type="text" onkeypress="return soloLetras(event)"  class="form-control"  value="{{Input::old('imparte')}}"   onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" />
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-sm-3 control-label">Anexar Imagen ó PDF: <strog class="theme_color"></strog></label>
													<div class="col-sm-6">
